 ...
 *
 * "Around" is a semantic hint for readability — the engine treats all
...
/**
 * Applies a custom interceptor to a method (semantic: around).
 */
...
class Around extends InterceptorAttribute
{
     ...
     * @param  array<string, mixed>  $params  Extra parameters forwarded to the interceptor via $args['__parameters'].
