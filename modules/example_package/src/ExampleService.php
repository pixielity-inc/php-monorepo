...
namespace Monorepo\ExamplePackage;

/**
 * ExampleService
 *
 * The primary entry-point for the example_package module.
 *
 * This service demonstrates the recommended pattern for shared modules
 * inside this monorepo:
 *   - Strict types enforced via `declare(strict_types=1)`.
 *   - PSR-4 namespace rooted at `Monorepo\ExamplePackage\`.
 ...
 *   // "repositories": [{ "type": "path", "url": "../../modules/example_package" }]
 *   // "require": { "monorepo/example-package": "*" }
 *
 ...
 *
 * @package Monorepo\ExamplePackage
 */
class ExampleService implements \Monorepo\ExamplePackage\Contracts\ServiceInterface
{
    /**
